...
export const createLotSchema = z.object({
  bookId:uuid,instrumentId:uuid,accountId:uuid.nullable().optional(),quantity,unitPrice:money,
  purchasedAt:isoDate,notes:z.string().max(1000).nullable().optional(),
});
export const updateLotSchema = z.object({
  instrumentId:uuid.optional(),accountId:uuid.nullable().optional(),quantity:quantity.optional(),unitPrice:money.optional(),
